  ...
  <div id="excalibur-root">
    ...
    <div id="excalibur-ui" class="w-100 d-flex align-center justify-center fill-height" ref="ui">
      ...
      <v-sheet id="excalibur-splashscreen" class="ui">
        <v-card v-if="updateTrigger && to_raw.game_mode === 'matching'" :loading="true" class="pa-2">
        ...
        <v-card v-if="updateTrigger && to_raw.game_mode === 'free_play'" :loading="true" class="pa-2">
          <v-card-title class="text-center">
            <h1 class="text-h3">
              Free play mode
            </h1>
          ...
          <v-card-text>
            <v-list lines="three" class="text-start">
              <v-list-item
                  title="Create your own potato"
              >
                <template v-slot:prepend>
                  <v-icon size="x-large">mdi-gesture-tap-button</v-icon>
                </template>
                <template v-slot:subtitle>
                  <strong>Clicking on the pieces</strong> as they appear
                  and <strong>click on the potato</strong> to add them.
                </template>
              </v-list-item>
              <v-list-item
                  title="Dance"
